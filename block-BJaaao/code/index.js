...
alert(`The value of num 1 is ${num1} and the value of num2 is ${num2}`)
...
const userProfession= prompt(`userProfession`);
let isAdult = confirm(`Are you above 18 ? `);
console.log(isAdult, USERNAME, userProfession, "Checking");
